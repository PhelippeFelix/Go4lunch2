...
public class SearchPlace {
    ...
    public void setHtmlAttributions(List<Object> htmlAttributions) { mHtmlAttributions = htmlAttributions; }
    public List<ResultSearch> getResultSearches() {
        return mResultSearches;
    }
    public void setResultSearches(List<ResultSearch> resultSearches) { mResultSearches = resultSearches; }
